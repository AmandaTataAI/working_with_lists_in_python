...
def find_if_characters_are_the_same():
    try:
        number_of_strings_that_the_user_will_enter = int(input("Please enter the number of strings you will enter: "))
        list_of_strings_that_the_user_entered = []
        i = 1
        while i <= number_of_strings_that_the_user_will_enter:
        ...
        while l <= number_of_strings_that_the_user_will_enter - 1:
