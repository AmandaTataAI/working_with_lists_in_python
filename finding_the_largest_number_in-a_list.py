...
def find_the_largest_number_in_a_list():
    try:
        ...
        while i <= number_of_numbers_that_the_user_will_enter_that_is_an_integer:
            ...
            list_of_numbers_that_the_user_entered_that_are_integers.append(number_that_the_user_has_entered_as_an_integer)
            i = i + 1
        ...
        def print_the_largest_number_in_a_list():
            print("\n")
            print(str(list_of_numbers_that_the_user_entered_that_are_integers[length_of_list_of_numbers_that_are_integers - 1]) +
